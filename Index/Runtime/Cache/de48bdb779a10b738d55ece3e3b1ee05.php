...
<div id="container">
  ...
  <div id="sidebar">
    ...
    <p><div style="text-align: center; font-weight: bold; font-size: 110%;"><?php echo C(STR_L2_CHECKLIST);?></div></p>
    <div style="text-align: center;"><form action="<?php echo U('/Panel/adminchecklist');?>" method="get"><?php echo C(STR_CHECKLIST_ADMIN);?><input type="text" name="id" class="tinyInput"/><input type="submit" value="<?php echo C(STR_CHECKLIST_GOTO);?>" name="usersubmit" id="usersubmit"/></form></div>

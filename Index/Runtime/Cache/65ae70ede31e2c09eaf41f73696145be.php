...
<div id="container">
  ...
  <p><div style="text-align: center; font-weight: bold; font-size: 110%;"><?php echo C(STR_CHECKLIST_ADD_ITEM_TITLE); echo ($field['subtitle']); ?></div></p>
  <p><?php echo ($field['item_notice']); ?></p>
  <form action="<?php echo U('/Panel/additemdone');?>" method="post">
    <table class="forms" align="center">
      <input type="hidden" name="id" value="<?php echo ($field['judge_id']); ?>" />
      <input type="hidden" name="type" value="<?php echo ($field['item_type']); ?>" />
      <tr>
        <td class="thin"><?php echo ($field['item_date']); ?></td>
        <td class="wide"><input type="text" name="date" class="smallInput"/></td>
      </tr>
      <tr>
        <td class="thin"><?php echo ($field['item_subject']); ?></td>
        <td class="wide"><input type="text" name="subject" class="smallInput"/></td>
      </tr> 
      <tr>
        <td class="thin"><?php echo ($field['item_body']); ?></td>
        <td class="wide"><input type="text" name="body" class="smallInput"/></td>
      </tr>     
      <tr>
        <td>
        <input type="reset" value="<?php echo C(STR_RESET);?>" name="userreset"/>
        </td>
        <td><input type="submit" value="<?php echo C(STR_SUBMIT);?>" name="usersubmit" id="usersubmit"/></td>
      </tr> 
    </table>
  </form>
  <p align="center"><a href="javascript:history.back(-1);"><?php echo C(STR_BACK);?></a></p>

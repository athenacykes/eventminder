...
<div id="container">
  ...
  <div class="clear"></div>
    ...
    <p><div style="text-align: center; font-weight: bold; font-size: 110%;"><?php echo C(STR_LOGIN);?></div></p>
 <form action="<?php echo U('auth');?>" method="post">
    <table class="forms" align="center">
      <tr>
        <td class="thin"><?php echo C(STR_USERNAME);?></td>
        <td class="wide"><input type="text" name="username" class="smallInput" maxLength="20"/></td>
      </tr>
      <tr>
        <td class="thin"><?php echo C(STR_PASSWORD);?></td>
        <td class="wide"><input type="password" name="password" class="smallInput" maxLength="20"/></td>
      </tr>    
 
      <tr>
        <td colspan="2" align="center">
        <input type="submit" value="<?php echo C(STR_SUBMIT);?>" name="loginsubmit" id="loginsubmit"/>
        </td>
      </tr> 
    </table>
  </form>
